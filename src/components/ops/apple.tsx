...
export const GLASS_SURFACE =
  "bg-[var(--scrim-void)] backdrop-blur-xl backdrop-saturate-150 border-t border-white/[0.06]";

/** Same material for sticky headers, where the divider belongs on the bottom edge. */
export const GLASS_HEADER =
  "bg-[var(--scrim-void)] backdrop-blur-xl backdrop-saturate-150 border-b border-white/10";
