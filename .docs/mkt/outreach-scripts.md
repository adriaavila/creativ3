...
Mensaje = observacion concreta + dolor probable + oferta pequena + permiso.

No vender "agencia". No vender "IA". Vender resultado medible.
...
> Si avanzamos a piloto o sprint en 14 dias, se descuenta del proyecto.
> Asi evitamos cotizar a ciegas y priorizamos lo que puede mover ventas/tiempo primero.
...
> - link web/IG
> - meta 30 dias
> - proceso que mas tiempo consume
> - confirmacion de diagnostico USD 150
> Entrego en 48h: score, 10 quick wins, roadmap y recomendacion honesta.

## Cierre de piloto

> Lo veo claro para piloto. Alcance inicial:
> - [workflow]
> - [integracion]
> - [medicion]
> Precio: USD [x]. 50% anticipo, 50% al salir en vivo. Timeline: [dias].

## Follow-ups

Dia 2:
> Te grabe/prepare 2 ideas sobre [dolor]. Te las paso?
