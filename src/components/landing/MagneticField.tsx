    ...
    <section className="theme-kinetic relative w-full overflow-hidden py-32 sm:py-48">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        <div className="flex flex-col gap-6">
          <span className="font-mono text-xs uppercase tracking-[0.2em] text-[#111214]/60">
            III · Campo de fuerza
          </span>
          <h2 className="font-display text-5xl sm:text-7xl leading-[0.95] tracking-tight text-[#111214]">
            Mueve <em className="text-[#8a8a8a] not-italic font-display italic">el cursor.</em>
            <br />
            Siente la <em className="italic">física.</em>
          </h2>
          <p className="font-mono text-sm sm:text-base text-[#111214]/70 max-w-md leading-relaxed">
          ...
          <div className="flex items-center gap-4 mt-2">
            <span className="inline-block w-2 h-2 rounded-full bg-[#8a8a8a] animate-pulse" />
            <span className="font-mono text-xs uppercase tracking-widest text-[#111214]/50">
