...
export default async function OpsCrmPage({
  ...
  if (!isOpsAuthConfigured() || !isGrowthDatabaseConfigured()) {
    return (
      <main className="on-ink flex min-h-dvh items-center justify-center bg-[var(--ink-fill)] p-6 text-white">
        <div className="max-w-xl rounded-2xl border border-white/10 bg-white/[0.04] p-8">
          <div className="font-mono text-[9px] uppercase tracking-[0.18em] text-[var(--assist-ink)]">Setup requerido</div>
