...
const PUERTAS = [
  { num: "I", label: "¿Tienes un proyecto en mente?", link: "mailto:proyectos@servicioscreativos.online" },
  { num: "II", label: "¿Quieres automatizar procesos?", link: "mailto:proyectos@servicioscreativos.online" },
  { num: "III", label: "¿Necesitas cotizar?", link: "mailto:proyectos@servicioscreativos.online" },
];
      ...
      <div ref={containerRef} className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {PUERTAS.map((puerta, i) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="puerta-card group flex flex-col justify-between aspect-[3/4] p-10 border border-papiro/20 hover:border-papiro/50 hover:bg-noche-rise/30 transition-all duration-500 hover-target"
          >
