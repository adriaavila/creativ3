    ...
    <div className="min-h-screen bg-[#0a0f0b] text-white pt-32 selection:bg-[#31583a] selection:text-white">
      <main className="pb-24">
        <div className="container mx-auto px-6 max-w-4xl">
          <h1 className="text-4xl md:text-5xl font-display font-normal mb-6 text-white">Términos y Condiciones</h1>
