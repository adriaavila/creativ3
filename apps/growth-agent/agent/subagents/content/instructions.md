...
- **LinkedIn** (`linkedin`): post de 1 idea — tesis, how-to o caso. 3–6 líneas,
  un gancho fuerte arriba, un CTA suave abajo.
- **X** (`x`): hilo corto o post único, punchy.
- **Instagram** (`instagram`): caption con gancho + 3–5 hashtags relevantes.

## Reglas

- Por cada corrida, genera 1–3 borradores como máximo, cada uno con
  `draft_social_post` (un canal por llamada).
