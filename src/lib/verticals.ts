...
export const VERTICALS: Record<VerticalSlug, Vertical> = {
  clinicas: {
    ...
    subtitle:
      "allok convierte tu web, agenda y WhatsApp en un sistema comercial que educa, filtra y prepara al paciente antes de que recepción intervenga.",
    pain: [
    ...
    message:
      "Hola, tengo una clinica/servicio wellness. Quiero ver si allok puede mejorar mis leads, agenda y WhatsApp.",
  },
  inmobiliarias: {
    slug: "inmobiliarias",
    icon: Home,
  ...
  ecommerce: {
    ...
    message:
      "Hola, tengo un ecommerce/marca. Quiero mejorar conversion, respuestas y seguimiento con allok.",
  },
  academias: {
    slug: "academias",
    icon: Dumbbell,
    ...
    subtitle:
      "allok arma paginas, reservas y automatizaciones que explican planes, responden dudas y llevan a la persona correcta hacia prueba, cupo o pago.",
    pain: [
    ...
    message:
      "Hola, tengo una academia/servicio recurrente. Quiero captar mas interesados y ordenar reservas con allok.",
  },
};
