    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-10 md:py-28">
        ...
        <Reveal className="mb-14 grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#c5f04a] px-3.5 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-[#111214]">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#c5f04a] px-5 py-3 text-sm font-semibold text-[#111214] transition-all duration-300 hover:-translate-y-0.5 hover:bg-white"
              >
                Quiero algo así
              ...
              <Reveal key={item.label} delay={i * 0.08}>
                <div className="flex items-center justify-between gap-4 rounded-lg border border-white/10 bg-white/[0.045] px-4 py-4">
                  <div className="flex items-center gap-3">
                    <Icon className="h-4 w-4 text-[#c5f04a]" />
