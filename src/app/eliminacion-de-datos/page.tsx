...
export default function LegalDataDeletion() {
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#0a0a0a] pt-32 selection:bg-[#a1a1a3]/30 selection:text-[#0a0a0a]">
      <main className="pb-24">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-8 text-[#6b6b6b] leading-8">
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-[#0a0a0a]">1. ¿Qué datos se eliminan?</h2>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>Envía un correo electrónico a <strong><a className="text-[#1c1d20] hover:underline" href="mailto:contacto@servicios.frontia.app">contacto@servicios.frontia.app</a></strong>.</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-[#0a0a0a]">3. Plazos de resolución</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-[#0a0a0a]">4. Servicios y APPs de Terceros</h2>
